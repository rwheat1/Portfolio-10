...
This plot reveals that, not only do people rate TCS items to reflect truthfulness more than other constructs, it is the only scale (of those included in this study) which does so!
...
ggplot(Item_Ratings_Long2, aes(x = ggplot_name, y = Avg_Pure_Rating, fill = ggplot_name)) +
  ...
  labs(title = "Truthfulness Purity Item Ratings",
       x = "Scale",
       y = "Informativeness About Truthfulness",
       fill = NULL)

```


These make things just as clear: most people think the TCS is a better measure of truthfulness on its face than each facet of Honesty-Humility, and HH overall.
